...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->privates['messenger.bus.default.middleware.handle_message'] = $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Message\\UserFormTypeMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.e5FpKew'] ?? $container->load('get_Messenger_HandlerDescriptor_E5FpKewService'));
            yield 1 => ($container->privates['.messenger.handler_descriptor.hlSahGK'] ?? $container->load('get_Messenger_HandlerDescriptor_HlSahGKService'));
